...
shield synthesis #cite(label("HybridPaper")). The present work integrates
...
learning. Here we shortly recall from #cite(label("HybridPaper")) how to
...
from #cite(label("HybridPaper")). @fig:bouncing_ball shows
...
shown in #cite(label("HybridPaper")) that a sampling-based shield synthesis
